...
export const Profile = () => {
  ...
  const changeProfile = async () => {
    try {
      ...
      const updated = await updateProfile(sessionStorage.getItem("token"), updatedFields)
            ...
            <article className="profileCardDesign">            
              <p>Nombre: 
                <FieldInput 
                  ...
                  onBlur={checkError}
                  className={disabled === "" ? "fieldInputDesign enabledInput" : "fieldInputDesign"} 
                />
              </p>
              {/* <div className="error">{profileError.firstNameError}</div> */}
              <p>Apellido: 
                <FieldInput 
                  type="text"
                  name="lastName"
              ...
              {/* <div className="error">{profileError.lastNameError}</div> */}
              <p>Email: 
                <FieldInput 
                  type="email"
                  name="email"
              ...
              {/* <div className="error">{profileError.emailError}</div> */}
            </article>
            <article className="profileCardDesign">  
              <Button 
                text={disabled === "" ? "Guardar" : "Edit"}
                functionClick={disabled === "" ? changeProfile : updateDisabled }
                currentClass={disabled === "" ? "buttonDesign update" : "buttonDesign"}/>
